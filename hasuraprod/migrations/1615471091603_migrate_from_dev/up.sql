...
CREATE TABLE public.pwa_befriender (
    pwa_id integer NOT NULL,
    befriender_id integer NOT NULL
);
CREATE TABLE public.pwa_befriender_core (
    pwa_id integer NOT NULL,
    staff_id integer NOT NULL
);
...
ALTER TABLE ONLY public.pwa_befriender_core
    ADD CONSTRAINT pwa_befriender_core_pkey PRIMARY KEY (pwa_id, staff_id);
ALTER TABLE ONLY public.pwa_befriender
    ADD CONSTRAINT pwa_befriender_pkey PRIMARY KEY (pwa_id, befriender_id);
...
ALTER TABLE ONLY public.pwa_befriender
    ADD CONSTRAINT pwa_befriender_befriender_id_fkey FOREIGN KEY (befriender_id) REFERENCES public.volunteers(id) ON UPDATE RESTRICT ON DELETE CASCADE;
ALTER TABLE ONLY public.pwa_befriender_core
    ADD CONSTRAINT pwa_befriender_core_pwa_id_fkey FOREIGN KEY (pwa_id) REFERENCES public.pwas(id) ON UPDATE RESTRICT ON DELETE CASCADE;
ALTER TABLE ONLY public.pwa_befriender_core
    ADD CONSTRAINT pwa_befriender_core_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.staffs(id) ON UPDATE RESTRICT ON DELETE CASCADE;
ALTER TABLE ONLY public.pwa_befriender
    ADD CONSTRAINT pwa_befriender_pwa_id_fkey FOREIGN KEY (pwa_id) REFERENCES public.pwas(id) ON UPDATE RESTRICT ON DELETE CASCADE;
ALTER TABLE ONLY public.pwa_comms
...
ALTER TABLE ONLY public.test
    ADD CONSTRAINT test_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.staffs(id) ON UPDATE RESTRICT ON DELETE CASCADE;
ALTER TABLE ONLY public.vol_languages
